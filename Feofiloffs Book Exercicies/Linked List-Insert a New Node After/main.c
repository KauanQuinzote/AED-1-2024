...
void add_between(Node **list, int num, int previous);
...
int main()
{
    ...
    do
    {
        ...
        case 4:
            printf("Add a node next to which cell?\n");
            scanf("%i", &previous);
            printf("Add wich value?\n");
            scanf("%i", &value);

            add_between(&list, value, previous);
...
void add_between(Node **list, int num, int previous)
{
    ...
    Node *aux = *list, *new = malloc(sizeof(Node));
